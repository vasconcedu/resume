...
- **Master Application Security Architect** @ SiDi, Brazil (remote)<br>
    ...
    - Performed Android malware reverse engineering and contributed to the development of malicious behavior detection heuristics and models;
